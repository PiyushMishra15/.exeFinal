  ...
  return (
    <div className="relative min-h-screen text-white flex flex-col justify-center items-center text-center font-poppins">
      ...
      <div className="container mx-auto py-8 px-4">
        {/* Page Title */}
        <h1
          className="text-4xl sm:text-5xl md:text-7xl font-bold text-center mb-16 p-6 fontdiner-swanky-regular bg-clip-text text-transparent bg-gradient-to-r from-blue-300 via-blue-500 to-blue-700 animate-gradient animate-title leading-tight"
          data-aos="fade-down"
        >
          Previous Events
        </h1>
