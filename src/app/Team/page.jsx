...
const Team = () => {
  ...
  const renderTeamSection = (title, members) => (
    <div className="team-category">
      <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-16 mt-16 text-center font-playfair text-gray-200 glow animate-pulse">
        {title}
      </h2>
              ...
              <div className="card-inner">
                ...
                <div className="card-front">
                  ...
                  <h4 className="tagline">
                    {member.tagline || "No Tagline Provided"}
                  </h4>
                </div>
  ...
  return (
    <section className="relative min-h-screen text-white flex flex-col justify-center items-center text-center font-poppins">
      ...
      />
      <div className="">
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold text-center mb-16 p-16 fontdiner-swanky-regular bg-clip-text text-transparent bg-gradient-to-r from-blue-300 via-blue-500 to-blue-700 animate-gradient animate-title leading-tight">
          Meet Our Team
        </h1>
      </div>
