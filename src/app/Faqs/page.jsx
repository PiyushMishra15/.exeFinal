          ...
          <div className="bg-gray-800 shadow-md rounded-lg p-6">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                >
                  <p className="text-gray-300">
                    Our events are open to everyone, regardless of their
                    branch/college. We welcome everyone with open arms.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                >
                  <p className="text-gray-300">
                    Team .EXE does a lot of technical stuff during the Nimbus.
                    We organize workshops, events, games, and work on various
                    projects.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                >
                  <p className="text-gray-300">
                    Yes, indeed! The workshops organized by Team .EXE are
                    absolutely free for everyone to attend.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                >
                  <p className="text-gray-300">
                    Our Club is open to anyone and everyone, regardless of their
                    branch. We conduct interviews every year for selecting new
                    members from First & Second year.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                >
                  <p className="text-gray-300">
                    You can stay updated about the club activities through our
                    official social media handles such as Instagram, LinkedIn,
                    and our website.
                  </p>
                </div>
              </div>
